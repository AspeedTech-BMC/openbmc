...
BRANCH = "develop"
SRC_URI = "git://gerrit.aspeed.com:29418/cptra_imgtool;protocol=ssh;branch=${BRANCH};"
SRCREV = "${AUTOREV}"
...
do_compile() {
    ...
    cargo build -p caliptra-auth-manifest-app-1x --release
...
do_install() {
    ...
    install -m 0755 ${B}/target/release/caliptra-auth-manifest-app-1x ${D}${bindir}
