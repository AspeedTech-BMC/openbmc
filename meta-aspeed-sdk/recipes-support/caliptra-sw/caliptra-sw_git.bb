...
SRC_URI = "gitsm://gerrit.aspeed.com:29418/caliptra-sw;protocol=ssh;branch=${BRANCH};"
SRCREV = "${AUTOREV}"
...
do_install() {
    ...
    install -m 0755 ${B}/target/release/caliptra-auth-manifest-app ${D}${datadir}/cptra-imgtool/
}
